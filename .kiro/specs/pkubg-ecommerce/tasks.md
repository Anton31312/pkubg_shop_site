...
- [x] 1.1 Настроить тестовую среду
...
- [x] 2. Создание моделей данных и базовой аутентификации
...
- [x] 2.1 Написать тест свойства для создания профиля при регистрации
  - **Свойство 9: Создание профиля при регистрации**
  - **Проверяет: Требования 3.1**

- [x] 2.2 Написать тест свойства для сохранения полной информации о товаре
  - **Свойство 22: Сохранение полной информации о товаре**
  - **Проверяет: Требования 6.1**

- [x] 2.3 Написать тест свойства для сохранения контента статьи
  - **Свойство 27: Сохранение контента статьи**
  - **Проверяет: Требования 7.1**

- [x] 3. Реализация API для управления товарами
...
- [x] 3.1 Написать тест свойства для отображения детальной информации о товаре


  - **Свойство 1: Отображение детальной информации о товаре**
  - **Проверяет: Требования 1.2**

- [x] 3.2 Написать тест свойства для релевантности результатов поиска


  - **Свойство 2: Релевантность результатов поиска**
  - **Проверяет: Требования 1.3**

- [x] 3.3 Написать тест свойства для соответствия фильтрам


  - **Свойство 3: Соответствие фильтрам**
  - **Проверяет: Требования 1.4**

- [x] 3.4 Написать тест свойства для скрытия кнопки у товаров без остатка


  - **Свойство 4: Скрытие кнопки для товаров без остатка**
  - **Проверяет: Требования 1.5**

- [x] 3.5 Написать тест свойства для отражения изменений товара в каталоге


  - **Свойство 23: Отражение изменений товара в каталоге**
  - **Проверяет: Требования 6.2**

- [x] 3.6 Написать тест свойства для корректного удаления товара


  - **Свойство 24: Корректное удаление товара**
  - **Проверяет: Требования 6.3**

- [x] 3.7 Написать тест свойства для оптимизации загружаемых изображений

  - **Свойство 25: Оптимизация загружаемых изображений**
  - **Проверяет: Требования 6.4**

- [x] 3.8 Написать тест свойства для запрета доступа неавторизованным пользователям

  - **Свойство 26: Запрет доступа неавторизованным пользователям**
  - **Проверяет: Требования 6.5**

- [x] 4. Создание системы корзины покупок
...
- [x] 4.1 Написать тест свойства для обновления счетчика корзины при добавлении


  - **Свойство 5: Обновление счетчика корзины при добавлении**
  - **Проверяет: Требования 2.1**

- [x] 4.2 Написать тест свойства для обновления суммы корзины при добавлении

  - **Свойство 6: Обновление суммы корзины при добавлении**
  - **Проверяет: Требования 2.2**

- [x] 4.3 Написать тест свойства для пересчета стоимости при изменении количества

  - **Свойство 7: Пересчет стоимости при изменении количества**
  - **Проверяет: Требования 2.3**

- [x] 4.4 Написать тест свойства для обновления корзины при удалении товара

  - **Свойство 8: Обновление корзины при удалении товара**
  - **Проверяет: Требования 2.4**

- [x] 5. Реализация личного кабинета пользователя
...
- [x] 5.1 Написать тест свойства для отображения истории заказов


  - **Свойство 10: Отображение истории заказов**
  - **Проверяет: Требования 3.2**

- [x] 5.2 Написать тест свойства для сохранения изменений профиля


  - **Свойство 11: Сохранение изменений профиля**
  - **Проверяет: Требования 3.3**

- [x] 5.3 Написать тест свойства для полноты информации о заказе


  - **Свойство 12: Полнота информации о заказе**
  - **Проверяет: Требования 3.4**

- [x] 5.4 Написать тест свойства для завершения сессии при выходе


  - **Свойство 13: Завершение сессии при выходе**
  - **Проверяет: Требования 3.5**

- [x] 6. Интеграция с платежной системой Ю.Касса
...
- [x] 6.1 Написать тест свойства для корректности перенаправления на оплату


  - **Свойство 14: Корректность перенаправления на оплату**
  - **Проверяет: Требования 4.2**

- [x] 6.2 Написать тест свойства для обновления статуса при успешной оплате


  - **Свойство 15: Обновление статуса при успешной оплате**
  - **Проверяет: Требования 4.3**

- [x] 6.3 Написать тест свойства для уведомления при отклонении оплаты


  - **Свойство 16: Уведомление при отклонении оплаты**
  - **Проверяет: Требования 4.4**

- [x] 6.4 Написать тест свойства для логирования ошибок платежей


  - **Свойство 17: Логирование ошибок платежей**
  - **Проверяет: Требования 4.5**

- [x] 7. Интеграция с службой доставки СДЭК
...
- [x] 8. Система управления статьями
...
- [x] 8.1 Написать тест свойства для обновления метаданных статьи


  - **Свойство 28: Обновление метаданных статьи**
  - **Проверяет: Требования 7.2**

- [x] 8.2 Написать тест свойства для публикации статьи


  - **Свойство 29: Публикация статьи**
  - **Проверяет: Требования 7.3**

- [x] 8.3 Написать тест свойства для запрета создания статей обычными пользователями


  - **Свойство 30: Запрет создания статей обычными пользователями**
  - **Проверяет: Требования 7.4**

- [x] 8.4 Написать тест свойства для архивирования удаленных статей
...
- [x] 9.1 Написать тест свойства для отображения общего количества товаров в корзинах
...
- [x] 10. Создание React фронтенда - основные компоненты
...
- [x] 11. Создание React фронтенда - личный кабинет и админ панель
...
- [x] 12. Стилизация и адаптивный дизайн
...
- [x] 12.1 Написать тест свойства для адаптивности интерфейса


  - **Свойство 32: Адаптивность интерфейса**
  - **Проверяет: Требования 8.3**

- [x] 12.2 Написать тест свойства для визуальной обратной связи


  - **Свойство 33: Визуальная обратная связь**
  - **Проверяет: Требования 8.4**

- [x] 12.3 Написать тест свойства для производительности загрузки


  - **Свойство 34: Производительность загрузки**
  - **Проверяет: Требования 8.5**

- [x] 13. Интеграция фронтенда с бэкендом
...
- [x] 13.1 Написать тест свойства для RESTful API структуры
